  ...
  return (
    <div className={styles.headerWrapper}>
      ...
      <div className={styles.brandLogo}>
        <span className="font-black tracking-widest uppercase">Bhojanalaya</span>
...
const styles = {
  ...
  brandLogo: "text-sm sm:text-lg tracking-wider text-orange-500 font-black cursor-pointer flex items-center shrink-0",
