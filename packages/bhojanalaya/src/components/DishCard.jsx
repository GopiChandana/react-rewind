...
const styles = {
  dishCard:
    "bg-zinc-900 border border-zinc-800 rounded-3xl p-5 flex flex-col gap-3 shadow-lg shadow-black/40 hover:border-zinc-700/50 hover:shadow-xl hover:shadow-black/60 hover:scale-[1.02] transition-all duration-300 ease-out hover:-translate-y-1.5",

  titleRow: "flex justify-between items-start",
  title: "text-zinc-100 font-bold text-lg capitalize",
